...
function $set(doc, vals){
  ...
  //document.model.schema should have something like .versionKey
  vals._id ? delete vals._id : null;
  und.isNumber(vals.__v) ? delete vals.__v : null;
...
function $increment(doc, vals, context){
  ...
  und.each(vals, function(val, key){
    if (und.isObject(val)){
      //TODO handle array of documents with _$where_ lookup
      //TODO handle incrementing a numeric array
