...
//TODO add support for custom validation. Such as restrict access to admins and owner of the doc
...
var plugin = function(Schema, globals){
  ...
  function del(id, acl, callback){
    var model = this;
    if (!callback) throw new Error('Callback required');
    acl = acl || {delete : 0};
    if (!acl.validateDelete(acl, model)){
      throw new Error('Access denied');
    }
